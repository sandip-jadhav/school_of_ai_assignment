        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    pass
                # Optional per-instance hook — subclasses can run JS extraction
                # before the browser closes (e.g. EcommerceBrowserSkill).
                _hook = getattr(self, "_post_page_hook", None)
                if callable(_hook):
                    try:
                        await _hook(page, result)
                    except Exception:                      # noqa: BLE001
                        pass
